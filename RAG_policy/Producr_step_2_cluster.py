...
csv_path = '/Users/shawn/Desktop/internship/UC-25-Summer-DATA601-AI-Agents/UC-25-Summer-DATA601-AI-Agents/RAG_policy/Producr Support cleaned.csv'
...
min_cluster_size = 10      # ★ Adjustable: minimum sentences per cluster
min_samples = None         # ★ Adjustable: noise sensitivity (None = automatic)
metric = "euclidean"
...
output_file = "product_support_clusters.json"
