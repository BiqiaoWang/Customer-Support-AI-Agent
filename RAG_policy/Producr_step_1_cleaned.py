...
# ===== 1. Product Support noise patterns (customer service + investigation requests) =====
noise_patterns = [
    ...
    r"(we understand|we are committed|feel free to reach|happy to assist)"
]


# ===== 2. Product Support core keywords (technical support/troubleshooting) =====
policy_keywords = [
    # System/application issues
    "crash", "crashes", "crashing", "freezing", "slow", "slowdown", "delays", "lag", "laggy",
    "error", "errors", "error message", "error messages", "bug", "bugs", "issue", "issues",
    # Network/connectivity
    "connection", "connectivity", "network", "disconnected", "timeout", "sync", "synchronization",
    "integration", "integrations", "api", "downtime", "outage", "outages",
    # Data/security
    "data breach", "security", "breach", "unauthorized access", "encryption", "access control",
    "discrepancy", "discrepancies", "inconsistent", "failure", "failures", "malfunction",
    # Performance/loading
    "loading", "load time", "performance", "server overload", "high traffic", "peak usage",
    "memory leak", "resource contention", "compatibility", "incompatible",
    # Tech stack keywords (extracted from samples)
    "analytics", "data analytics", "investment optimization", "digital campaign", "marketing",
    "integration", "troubleshooting", "restart", "update", "patch", "firmware", "logs"
]
...
def clean_answer(answer: str) -> str:
    ...
    for s in sentences:
        ...
        if is_noise_sentence(s_strip):
            continue
        # 2) Keep Product Support technical sentences
...
def main():
    input_path = '/Users/shawn/Desktop/internship/UC-25-Summer-DATA601-AI-Agents/UC-25-Summer-DATA601-AI-Agents/RAG_policy/Producr Support.csv'
    output_path = "/Users/shawn/Desktop/internship/UC-25-Summer-DATA601-AI-Agents/UC-25-Summer-DATA601-AI-Agents/RAG_policy/Producr Support cleaned.csv"
