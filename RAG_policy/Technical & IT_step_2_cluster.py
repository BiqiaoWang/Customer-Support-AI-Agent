...
csv_path = '/Users/shawn/Desktop/internship/UC-25-Summer-DATA601-AI-Agents/UC-25-Summer-DATA601-AI-Agents/RAG_policy/Technical& IT Support_cleaned.csv'  # cleaned file from step 1
...
# IT topics很多，一般簇会比较多，先用 10 作为最小簇大小
min_cluster_size = 10
min_samples = None
metric = "euclidean"
...
output_file = "technical_it_support_clusters.json"
