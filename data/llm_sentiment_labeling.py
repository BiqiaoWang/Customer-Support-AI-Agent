...
OUT_PRED_LLAMA = "pred_llama31_8b_instant.csv"
OUT_PRED_LLAMA33 = "pred_llama33_70b.csv"
OUT_METRICS = "metrics_compare.txt"


# Columns
ID_COL = "ticket_id"
TEXT_COL = "ticket_description"
GOLD_COL = "gold_label"  # optional: only needed if you want metrics
...
def main():
    ...
    # Optional metrics (Negative class)
